        ...
        <div className="panel">
            <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                ...
                >
                   ...
                   <AddBlog showAddBlogForm={showAddBlogForm} setShowAddBlogForm={setShowAddBlogForm} />
                        ...
                        { accessor: 'role', title: 'Role', sortable: true },
                        {
                            ...
                            render: () => (
                                <div className="flex items-center w-max mx-auto gap-2">
                                    <Tippy >
                                        <button type="button" className=""  onClick={() => setShowEditBlogForm(!showEditBlogForm)}>
