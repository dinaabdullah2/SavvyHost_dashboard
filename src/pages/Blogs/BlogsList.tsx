...
const BlogsList = () => {
    ...
    console.log('🚀 ~ file: PagesList.tsx:49 ~ Pages:',Blogs?.data?.blogs);
    ...
    const [initialRecords, setInitialRecords] = useState(sortBy(Blogs?.data?.blogs, 'id'));
    ...
    //         });
    //     })}else{
    //         setInitialRecords(Blogs?.data?.blogs)
    //     }
    ...
    const { mutate: deleteBlog } = useMutate({
        mutationKey: [`blog/id/{id}`],
        endpoint: `api/dashboard/blog/${idBlog?.id}`,
        onSuccess: (data: any) => {
            console.log('done');
            Swal.fire({ title: 'Deleted!', text: 'Your Blog has been deleted.', icon: 'success', customClass: 'sweet-alerts' });
            ...
            <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                ...
                <button
                 ...
                 >
                   ...
                   <AddBlog  refetch={refetch}  blogData={blogData} showAddBlogForm={showAddBlogForm} setShowAddBlogForm={setShowAddBlogForm} />
                   {/* <EditBlog showEditBlogForm={showEditBlogForm} setShowEditBlogForm={setShowEditBlogForm} /> */}
                </div>
            </div>
