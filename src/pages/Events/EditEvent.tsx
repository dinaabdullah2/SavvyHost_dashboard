...
type EventCustom_TP = {
    ...
    setShowEditEventsForm?:any

  };

const EditEvent = ({
    showEditEventForm,
    setShowEditEventsForm,
  ...
  return (
    <div>
    <div className={`${(showEditEventForm && '!block') || ''} fixed inset-0 bg-[black]/60 z-[51] px-4 hidden transition-[display]`} onClick={() => setShowEditEventsForm(false)}></div>

    <nav
        className={`${
            (showEditEventForm && 'ltr:!right-0 rtl:!left-0') || ''
    ...
    >
        ...
        <div className="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
            <div className="text-center relative pb-5">
                <button type="button" className="absolute top-0 ltr:right-0 rtl:left-0 opacity-30 hover:opacity-100 dark:text-white" onClick={() => setShowEditEventsForm(false)}>
                    <svg
                ...
                <h4 className="mb-1 dark:text-white font-semibold text-lg"> Edit Event </h4>
