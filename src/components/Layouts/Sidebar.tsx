                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">Stay Expo</span>
                        </NavLink>
                                    ...
                                    <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'Blogs' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('Blogs')}>
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Blogs</span>
                                            </div>
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Booking</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
